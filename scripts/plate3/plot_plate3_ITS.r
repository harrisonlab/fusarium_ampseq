...
# df1 <- read.delim("~/Downloads/AHDB_new/plate3/quantified/mix-A/onion/mix-A_ITS_zOTUs_zOTUs_table.txt")
...
ggsave(filename, plot = facet_species, width =50, height = fig_height, units = "cm", limitsize = FALSE)

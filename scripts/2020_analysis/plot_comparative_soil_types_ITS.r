...
# Read data:
df1 <- read.delim2('/Volumes/GGB/Harrison/Projects/AHDB-FOC-2019-C300106/Science/Obj4-Establish-Potential-AmpliconSeq/metabarcoding_data/3\ taxon\ abundance\ tables/comparative\ soil\ types/ITS/ITS_soil_samples_zOTUs_table.txt'
...
prefix <- "comparative_soil_types_ITS"

...
# Read data:
df1 <- read.delim("/Volumes/GGB/Harrison/Projects/AHDB-FOC-2019-C300106/Science/Obj4-Establish-Potential-AmpliconSeq/metabarcoding_data/3 taxon abundance tables/FOC FON FOM soils/TEF/TEF_2019_samples_no-mismatches_zOTUs_table.txt")
